...
chatRouter.get("/conversations", Authenticate, chatController.getConversationsList)
chatRouter.get('/messages/:conversationId', Authenticate, validateParams(conversationIdSchema), chatController.getConversationMessages)
